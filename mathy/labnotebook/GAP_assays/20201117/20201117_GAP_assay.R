...
outdir <- "~/gdrive/gsp1_dms/mathy/labnotebook/GAP_assays/20201117/"   ### the output you need will be in a reaction_mix_temp.txt file
GAPs <- c("SpRNA1")
...
GAP.stock <- 10  # nM
GAP.working <- 1 # nM
Rans.stock.conc <- c(125.28, 43.54, 62.76)
#################################################
#################################################
sensor <- c('sensor')
