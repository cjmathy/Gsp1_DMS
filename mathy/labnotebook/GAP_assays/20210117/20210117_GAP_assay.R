...
outdir <- "~/gdrive/gsp1_dms/mathy/labnotebook/GAP_assays/20210117/"   ### the output you need will be in a reaction_mix_temp.txt file
GAPs <- c("SpRNA1")
...
row <- "C"
date <- "20210117"
Rans <- c('WT', 'G35D', 'G35A', 'WT', 'G35D', 'G35A')
GAP.stock <- 10  # nM
GAP.working <- 1 # nM
Rans.stock.conc <- c(66.9, 104, 47.7, 61.8, 147, 69.5) # uM
#################################################
#################################################
sensor <- c('sensor')
