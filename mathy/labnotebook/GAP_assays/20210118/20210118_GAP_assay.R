...
outdir <- "~/gdrive/gsp1_dms/mathy/labnotebook/GAP_assays/20210118/"   ### the output you need will be in a reaction_mix_temp.txt file
GAPs <- c("SpRNA1")
...
row <- "E"
date <- "20210118"
Rans <- c('F54A', 'F54K', 'F54W','F54A', 'F54K', 'F54W')
GAP.stock <- 10  # nM
GAP.working <- 1 # nM
Rans.stock.conc <- c(43.8, 24.6, 39.3, 43.3, 21, 29.8) # uM
#################################################
#################################################
sensor <- c('sensor')
